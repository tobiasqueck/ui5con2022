sap.ui.require([
  ...
  var sViewName = "ui5con.demo.ts.travel.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of ui5con.demo.ts.travel"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title ui5con.demo.ts.travel"
            });
        }
      }
